...
class ChooseRounds:
    ...
    def __init__(self):
        ...
        self.choose_instructions_label = Label(self.intro_frame,
                                               ...
                                               wraplength=300, justify="center", bg=bg_color)
        ...
        self.submit_button = Button(self.round_frame, text="Start",
                                    command=self.start_game, bg=button_fg, font=button_font)
        self.submit_button.grid(row=0, padx=10, pady=10, column=1)

        self.output_label = Label(self.round_frame, text="",
                                  fg="#9C0000", bg=bg_color)
    ...
    def start_game(self):
        try:
            ...
            self.output_label.config(text="Please enter a number")
